...
const products = [
  {
    title: "SaaS B2B para post venta y clientes.",
    label: "Post venta",
  ...
  {
    title: "SaaS inmobiliario para leads y propiedades.",
    label: "Inmobiliaria",
  ...
  {
    title: "Actividades diarias con tareas y evidencias.",
    label: "Operaciones",
  ...
  {
    title: "Gestion tipo Airbnb para reservas y check-in.",
    label: "Reservas",
    image: "/about-team-impact.png",
    icon: KeyRound,
    tone: "bg-accent",
  },
  {
    title: "Soluciones de software listas para adaptar.",
    label: "A medida",
    image: "/service-saas.png",
    icon: Settings2,
    tone: "bg-primary",
  ...
  return (
    <section ref={sectionRef} className="bg-inherit">
      ...
      >
        ...
        <div className="products-copy relative z-10 mx-auto flex min-h-[280px] max-w-[1780px] flex-col justify-end gap-5 px-4 pb-8 pt-20 sm:min-h-[330px] sm:gap-8 sm:px-10 sm:pb-10 sm:pt-24 lg:grid lg:min-h-[42vh] lg:grid-cols-[1fr_1.05fr] lg:items-end lg:px-14 lg:pb-0">
          ...
          <h2 className="max-w-[790px] text-[clamp(2.15rem,11vw,5.6rem)] font-black uppercase leading-[0.9] text-brand-black sm:text-[clamp(2.35rem,5vw,5.6rem)] sm:leading-[0.88]">
            Productos digitales listos para operar.
          </h2>
          <p className="max-w-[790px] text-left text-xl font-black uppercase leading-[1] text-brand-black sm:text-[clamp(1.7rem,3.2vw,4.2rem)] sm:leading-[0.9] lg:justify-self-end lg:text-right">
            SaaS B2B, inmobiliaria, reservas, operaciones y soluciones a medida.
          </p>
        </div>
          ...
          >
            {products.map((product, index) => {
              ...
              return (
                ...
                >
                  <div className={`absolute inset-0 ${product.tone}`} />
